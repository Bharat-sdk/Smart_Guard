...
fun Fragment.dialogVerifySensorAddition(): Dialog {
    val dialog = Dialog(requireContext())

    val binding = DataBindingUtil.inflate(LayoutInflater.from(requireContext()), R.layout.dialog_add_sensor_message, null, false) as DialogAddSensorMessageBinding
